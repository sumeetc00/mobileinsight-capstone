...
class OfflineReplayer(Monitor):
    ...
    def run_data(self, binary_array: list):
        ...
        try:
            ...
            while True:
                ...
                # TODO: whatever the equivalent of reading 64 bytes of an array is
                # Since I assume we are passing in an array of binary characters, each is 1 bit, maybe:
                s = binary_array[start: start + delta]
                # Then increase start by delta at the end
    ...
    def run_files(self, file_names: set):
        """
        Start monitoring the mobile network. This is usually the entrance of monitoring and analysis.
        """
        ...
        try:
            ...
            for file_name in file_names:
                if os.path.isfile(self._input_path + file_name):
                    log_list.append(os.path.join(self._input_path, file_name))
                else:
                    return
